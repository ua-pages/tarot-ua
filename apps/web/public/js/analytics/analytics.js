const POSTHOG_KEY = window.ENV?.VITE_POSTHOG_KEY;
const POSTHOG_HOST = window.ENV?.VITE_POSTHOG_HOST || 'https://eu.i.posthog.com';
const ANALYTICS_ENABLED = window.ENV?.VITE_ANALYTICS_ENABLED !== 'false';
